  ...
  const handleSignIn = async (provider: "github" | "google") => {
    ...
    try {
      await authClient.signIn.social({
        provider,
        callbackURL:
          process.env.NEXT_PUBLIC_BERND_URL || "http://localhost:3000",
      });
    } catch {
...
function GoogleLogoIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg className="w-5 h-5" viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fill="#4285F4"
...
function GitHubLogoIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="15"
      height="15"
